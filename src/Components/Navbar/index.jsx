...
const Navbar = ({ onWorkspaceSelect }) => {
  ...
  useEffect(() => {
    const fetchWorkspaces = async () => {
      try {
        ...
        const data = await response.json();
        setWorkspaces(data);
        // Set the first workspace as default if none selected
  ...
  // Fetch boards for the selected workspace
  useEffect(() => {
    const fetchBoards = async () => {
  ...
  const handleWorkspaceClick = (workspaceId) => {
    ...
    onWorkspaceSelect(workspaceId); // Notify parent component
  ...
  const handleCreateWorkspace = async () => {
    ...
    try {
      ...
      setSelectedWorkspaceId(newWorkspace._id); // Select the new workspace
